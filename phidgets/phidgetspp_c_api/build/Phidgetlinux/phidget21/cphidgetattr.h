...
typedef enum  {
	...
	PHIDID_SPACIAL_ACCEL_3AXIS				= 0x07F,	/**< Phidget Spacial 3-axis accel (1049) */
	PHIDID_IR								= 0x04D,	/**< Phidget IR Receiver Transmitter (1055) */
	PHIDID_SPACIAL_ACCEL_3_GYRO_1			= 0x04E,	/**< Phidget Spacial 3-axis accel with 1-axis gyro (1056) */
	PHIDID_SPACIAL_ACCEL_GYRO_COMPASS		= 0x033,	/**< Phidget Spacial 3/3/3 */
