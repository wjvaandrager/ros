...
#ifdef DEBUG
const char LibraryVersion[] = "Phidget21 Debug - Version 2.1.6 - Built " __DATE__
    " " __TIME__;
#else
const char LibraryVersion[] = "Phidget21 - Version 2.1.6 - Built " __DATE__
    " " __TIME__;
#endif
...
{ PHIDID_SPACIAL_ACCEL_GYRO_COMPASS,	PHIDCLASS_SPATIAL,			0x6C2, 0x33,	0, { UFINTS(spatial,			3,3,3) },	"Phidget Spacial 3/3/3"},
...
{ PHIDID_SPACIAL_ACCEL_3_GYRO_1,		PHIDCLASS_SPATIAL,			0x6C2, 0x4E,	0, { UFINTS(spatial,			3,1,0) },	"Phidget Spacial 3/1/0"},
{ PHIDID_ENCODER_HS_4ENCODER_4INPUT,	PHIDCLASS_ENCODER,			0x6C2, 0x4F,	0, { UFINTS(encoder,			4, 4) },	"Phidget High Speed Encoder 4-encoder 4-input"},
...
{ PHIDID_GYROSCOPE,						PHIDCLASS_GYROSCOPE,		0x6C2, 0x75,	0, { UFINTS(gyroscope,			1) },		"Phidget Gyroscope"},					//PROTOTYPE - 1 axis gyro
...
{ PHIDID_SPACIAL_ACCEL_3AXIS,			PHIDCLASS_SPATIAL,			0x6C2, 0x7F,	0, { UFINTS(spatial,			3,1,0) },	"Phidget Spacial 3/0/0"},
