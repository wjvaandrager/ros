...
//If you modify this, it's NEEDS to be modified in .NET!!!
/**
 ...
 */
PHIDGET21_API int CCONV CPhidgetIR_TransmitRaw(CPhidgetIRHandle phid, int *data, int length, int carrierFrequency, int dutyCyle, int gap);
/**
