...
void CCONV CPhidget_free(void *arg)
{
	...
	//For now, we deal with freeing this explicitely
	//if(phid->networkInfo)
...
CPhidget_getDeviceName(CPhidgetHandle phid, const char **buffer)
{
	...
	*buffer = (char *)(Phid_Device_Def[phid->Phid_Device_Def_index].pdd_name);
	return EPHIDGET_OK;
}
...
int attachActiveDevice(CPhidgetHandle activeDevice, CPhidgetHandle attachedDevice)
{
	...
	activeDevice->Phid_Device_Def_index = attachedDevice->Phid_Device_Def_index;
#endif
#endif
