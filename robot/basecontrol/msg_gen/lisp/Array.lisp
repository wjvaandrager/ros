...
(cl:defmethod cl:initialize-instance :after ((m <Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basecontrol-msg:<Array> is deprecated: use basecontrol-msg:Array instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basecontrol-msg:data-val is deprecated.  Use basecontrol-msg:data instead.")
  (data m))
