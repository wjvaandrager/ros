/* Auto-generated by genmsg_cpp for file /home/pc_willem/ros/rosserial/rosserial_msgs/msg/TopicInfo.msg */
...
struct MD5Sum< ::rosserial_msgs::TopicInfo_<ContainerAllocator> > {
  ...
  {
    return "af972f89eab8180c74022cbaed55d206";
  }

  static const char* value(const  ::rosserial_msgs::TopicInfo_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xaf972f89eab8180cULL;
  static const uint64_t static_value2 = 0x74022cbaed55d206ULL;
};
...
struct Definition< ::rosserial_msgs::TopicInfo_<ContainerAllocator> > {
  static const char* value() 
  {
    return "#The topic_id defines the communication endpoint for this type of message\n\
uint16 topic_id\n\
\n\
